...
## THE PROBLEM: £2.1B AT RISK

The UK North Sea decommissioning crisis (5,600+ wells, £60B total cost 2026-2050):

1. **Data Decay**: 57 years of records across paper/microfiche/SQL (1967-2024)
2. **Datum Errors**: 80ft vertical shifts (KB→GL conversions) corrupt £2.1B in decommissioning bonds
3. **"Phantom Emissions"**: Depth errors → incorrect UK ETS carbon tax reporting
4. **HMRC Repudiation**: £1.58B EPL tax relief at stake without non-repudiable evidence
5. **NSTA Mandate**: WIOS (Jan 8, 2026) requires "AI-supported data discovery"

**Example:** Thistle A-12 wellbore
- Incorrect depth: 8,247 ft → Correct: 8,214 ft (-80ft datum error)
- Impact: £20M decommissioning bond value erosion per field

---

## THE SOLUTION: THE BRAHAN ENGINE

Sovereign Industrial AI platform with three pillars:
...
| Region | Wells | TAM (£50K/well) |
|--------|-------|-----------------|
| **UK North Sea** | 5,600 | **£280M** |
| Norwegian Continental Shelf | 3,800 | £190M |
| Danish Sector | 1,200 | £60M |
| Gulf of Mexico | 8,000+ | £400M+ |
| **TOTAL** | **18,600+** | **£930M** |

### Serviceable Obtainable Market (SOM)
**Year 1:** Perfect 11 assets (442 wells) = £22.1M revenue
**Year 3:** UK North Sea penetration (2,000 wells) = £100M revenue
...
**Revenue:** £50,000 per well forensic audit (SaaS subscription)

**Example ROI for Customer (Thistle Field, 40 wells):**
- Liability Mitigation: £168M (depth error correction)
- Carbon Tax Savings: £1,632 ("Phantom Emissions" eliminated)
- EPL Tax Relief: £150M (HMRC fiscal integrity)
- **Total Value:** £318M
- **WellTegra Cost:** £2.0M
...
- LTV:CAC: 18:1 (regulatory mandate = organic acquisition)
- Payback Period: 2 months (urgent decommissioning timeline)

---

## FINANCIAL PROJECTIONS (3 YEARS)

| Year | Wells | Revenue | Gross Profit | EBITDA |
|------|-------|---------|--------------|--------|
| **2026** | 442 | £22.1M | £20.3M | £12.5M |
| **2027** | 1,200 | £60.0M | £55.2M | £38.0M |
| **2028** | 2,500 | £125.0M | £115.0M | £85.0M |

**Assumptions:**
- £50K per well average selling price
- 92% gross margin (SaaS platform)
- 68% EBITDA margin (Year 3, scaled operations)

---

## TEAM

**Kenneth McKenzie, Founder & Chief AI Architect**
- 30 years Engineer of Record (Perfect 11 North Sea assets)
...
**Contact:**
Kenneth McKenzie, Chief AI Architect
kenneth.mckenzie@welltegra.network
https://welltegra.network

**WellTegra Ltd | SC876023 | January 21, 2026**
