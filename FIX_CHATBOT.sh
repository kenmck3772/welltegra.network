#!/bin/bash
# This script will restore the chatbot file with the correct content

cat > portfolio-assistant.js << 'ENDFILE'
/**
...
echo "✅ File restored! Now checking..."
wc -l portfolio-assistant.js
